...
with
    ...
    , transformacoes as (
        select
            ...
            , *
        from join_tabelas
        /*Esta foi uma forma didatica de criar a surrogate key porem não é a condiçao ideal pois 
        ao entrar um novo registro no meio na tabela, a chave ira se alterar e isso não é desejado */
    )
select *
from transformacoes